...
\begin{table}[t]
  ...
  \begin{tabular}{llccccc}
    ...
    \midrule
    P1 always-retrieve   & open & F1   & ---    & \textbf{\fOnePoneOpen}  & \retPoneOpen  & 23\,s \\
    P3 closed-book$^{*}$ & open & F1   & \fOnePthreeOpen & \fOnePthreeOpen  & \retPthreeOpen & 27\,s \\
    P5 gated (calib.)    & open & F1   & 0.191$^{\ddagger}$ & \textbf{\fOnePfiveOpen} & \retPfiveOpen & 380\,s \\
    \bottomrule
  \end{tabular}
...
specific study findings, retrieval genuinely adds information, and P5 (F1 \fOnePfiveOpen)
edges above closed-book (\fOnePthreeOpen). Retrieval helps precisely when the model does not
