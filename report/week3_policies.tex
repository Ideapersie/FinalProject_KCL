...
multiple-choice accuracy falls} from 62.0\% (identical to closed-book, when it
...
\begin{table}[t]
  ...
  \begin{tabular}{lccccc}
    ...
    P3 closed-book       & MCQ  & 200 & 62.0\%          & 0\%   & 57\,s \\
    P5 gated (uncalib.)  & MCQ  & 200 & 62.0\%          & 0\%   & 142\,s \\
    P5 gated (calibrated)& MCQ  & 200 & 45.5\%          & 50\%  & 159\,s \\
    \midrule
    P3 closed-book       & open & 200 & 0.190 (F1)      & 0\%   & 27\,s \\
