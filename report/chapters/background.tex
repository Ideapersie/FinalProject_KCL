...
The connectivity and electrification figures behind this work were given in
Chapter~\ref{ch:intro} \citep{itu2025factsfigures, sdg7tracking2025}, and
clinical decision-support research aimed at those settings has begun to treat
offline-first operation as a hard requirement rather than a degraded mode.
\citet{walusimbi2026aletheia} build an on-device diagnostic-support system for
sub-Saharan African district hospitals on exactly those grounds, that
connectivity-dependent tools are structurally unavailable where
physician-to-patient ratios are worst. That line of work concentrates on
diagnosis, and the question of when such a system should consult an external
corpus is to the author's knowledge unexamined in the offline-clinical
setting.
