...
ensemble evaluated end-to-end on three quantised models, at 3B, 7B and 14B,
...
correct answers and fixed 13, a harmful ratio of $3.5{:}1$, with chunks equally
...
clinical bar, since the best, closed-book at \accPthreeMcq{}, is
...
\begin{enumerate}
  ...
  \item \textbf{Statistical power.} The full 7,663-question MIRAGE
    ...
    given that the current $n=6$ is the single weakest point of the safety
