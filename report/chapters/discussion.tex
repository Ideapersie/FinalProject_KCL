...
corpus lacked answers, retrieval could never turn a wrong answer right ---
yet it \emph{fixes} \fixLlama{}, \fixQwenSeven{} and \fixQwenFourteen{}
...
\emph{either} direction --- a measurement limitation rather than a null
...
$n_{\text{prompt}} - 1$ rows. The discrepancy was confirmed directly ---
...
(Section~\ref{sec:scaling-bars}). This deployment class --- fully offline,
quantised, commodity-hardware clinical QA --- is not fit for clinical
