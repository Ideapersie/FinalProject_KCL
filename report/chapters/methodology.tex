...
retrieval gates, which are the core novel contribution, were developed against a
...
breadth without informing the central question of when a system
...
mass spreads wherever multiple phrasings are equally acceptable, such as
formatting tokens, function words and punctuation, regardless of whether
...
\emph{Verbalized confidence}, meaning asking the model to rate its own
answer, is the standard third option, but \citet{kadavath2022} show
...
signals derived from \emph{different} aspects of the model's behaviour, namely
...
\emph{complicates} this design story, since the ablation in
