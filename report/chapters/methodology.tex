...
which extends P1 by asking the model to name its sources, matched leniently back to
retrieved chunks after the attribution-evaluation convention of
\citet{alce2023} but1 is not evaluated as a distinct condition here, for two
